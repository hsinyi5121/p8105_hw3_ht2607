...
```
In the visualization of the age distribution for men and women in each education category, we can see that more females that is less than age of 50 are in the more than high school education category. Also, we can see that there is more females that age more than 60 are in the high school equivalent education category. Additionally, there is more males that age less than 50 are in the high school equivalent education category. 
